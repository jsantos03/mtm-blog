module.exports = {
  ...
  authorTwitterAccount: "juansantos03",

  /* info */
  headerTitle: "MTM-Blog",
  headerSubTitle: "Maldonado Tech Meetup",

  /* manifest.json */
  manifestName: "MTM-Blog - Maldonado Tech Meetup",
  manifestShortName: "MTM-Blog", // max 12 characters
  ...
  // social
  authorSocialLinks: [
    { name: "github", url: "https://github.com/jsantos03/" },
    { name: "twitter", url: "https://twitter.com/juansantos03" },
    { name: "meetup", url: "https://www.meetup.com/es/Maldonado-New-Technology-Meetup" }
  ]
};
